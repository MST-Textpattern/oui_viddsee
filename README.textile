...
"oui_viddsee":https://github.com/NicolasGraph/oui_viddsee is a "oui_player":https://github.com/NicolasGraph/oui_player v2+ extension to easily embed "Viddsee":https://viddsee.go.com/ provided videos in "Textpattern":https://textpattern.com/ powered websites.
...
oui_viddsee's minimum requirements:
...
# "Download":https://github.com/NicolasGraph/oui_viddsee/releases the compiled plugin file or the source to compile a customized file.
...
# Install oui_viddsee:
@$ composer require nicolasgraph/oui_viddsee@
...
bc. $ composer update nicolasgraph/oui_viddsee
...
bc. $ composer remove nicolasgraph/oui_viddsee
...
oui_viddsee version 1.0.0-BETA2, Copyright (C) 2018 Nicolas Morand
...
* *oui_viddsee v1.0.0-BETA2* (2018-07-04)
